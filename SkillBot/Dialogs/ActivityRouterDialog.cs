...
namespace Microsoft.BotBuilderSamples.SSOSkillBot.Dialogs
{
    ...
    public class ActivityRouterDialog : ComponentDialog
    {
        ...
        private async Task<DialogTurnResult> ProcessActivityAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            if (stepContext.Context.Activity.Type == ActivityTypes.Event && stepContext.Context.Activity.Name == "CLU")
            {
                //var messageText = "Tell me what you want to do?";
                await stepContext.Context.SendActivityAsync("User successfully redirected to skill bot.", cancellationToken: cancellationToken);
