...
namespace Microsoft.BotBuilderSamples
{
    ...
    public class FlightBooking : IRecognizerConvert
    {
        ...
        public class CluEntities
        {
            ...
            public CluEntity[] GetStartTimeList() => Entities.Where(e => e.Category == "startTime").ToArray();
            public CluEntity[] GetEndTimeList() => Entities.Where(e => e.Category == "endTime").ToArray();
            public CluEntity[] GetLocationList() => Entities.Where(e => e.Category == "location").ToArray();

            public string GetStartTime() => GetStartTimeList().FirstOrDefault()?.Text;
            public string GetEndTime() => GetEndTimeList().FirstOrDefault()?.Text;
