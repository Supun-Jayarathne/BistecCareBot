...
namespace Microsoft.BotBuilderSamples.SSORootBot.Dialogs
{
    public class SsoSignInDialog : ComponentDialog
    {
        ...
        private async Task<DialogTurnResult> SignInStepAsync(WaterfallStepContext context, CancellationToken cancellationToken)
        {
            ...
            //return await context.NextAsync(context);
        ...
        private Attachment CreateAdaptiveCardAttachment()
        {
            ...
            using (var stream = GetType().Assembly.GetManifestResourceStream(cardResourcePath))
            {
                using (var reader = new StreamReader(stream))
                {
                    ...
                    string baseUrl = $"https://bisteccareltddev.b2clogin.com/bisteccareltddev.onmicrosoft.com/b2c_1a_signup_signin/oauth2/v2.0/authorize?client_id=4521dfe1-0635-4a44-bd4a-f4b42fca2067&scope=openid%20profile%20email%20offline_access%20https%3A%2F%2Fbisteccareltddev.onmicrosoft.com%2F4521dfe1-0635-4a44-bd4a-f4b42fca2067%2FCalendar.Read&redirect_uri=https%3A%2F%2Fsupunrootbotapp.azurewebsites.net%2Fcallback&client-request-id=b7e4635f-1844-4421-adfb-e6d10e7ff2e7&response_mode=query&response_type=code&x-client-SKU=msal.js.browser&x-client-VER=2.24.0&client_info=1&code_challenge=0Opx5Tt1Kd-UB3iGV6nIbKQjAoetrarSEaHV6lEVXcM&code_challenge_method=S256&nonce=d417b619-d010-425e-a2cf-464f886a3b71&state=eyJpZCI6IjMxMTcxMzZhLThiZTEtNGM0Ny1iY2Y0LTk3MGI2YjVjMmM1ZiIsIm1ldGEiOnsiaW50ZXJhY3Rpb25UeXBlIjoicmVkaXJlY3QifX0%3D";
                    //string baseUrl = $"https://bisteccareltddev.b2clogin.com/bisteccareltddev.onmicrosoft.com/b2c_1a_signup_signin/oauth2/v2.0/authorize?client_id=4521dfe1-0635-4a44-bd4a-f4b42fca2067&scope=openid%20profile%20email%20offline_access%20https%3A%2F%2Fbisteccareltddev.onmicrosoft.com%2F4521dfe1-0635-4a44-bd4a-f4b42fca2067%2FCalendar.Read&redirect_uri=https://token.botframework.com/api/oauth/PostSignInCallback&client-request-id=b7e4635f-1844-4421-adfb-e6d10e7ff2e7&response_mode=query&response_type=code&x-client-SKU=msal.js.browser&x-client-VER=2.24.0&client_info=1&code_challenge=0Opx5Tt1Kd-UB3iGV6nIbKQjAoetrarSEaHV6lEVXcM&code_challenge_method=S256&nonce=d417b619-d010-425e-a2cf-464f886a3b71&state=eyJpZCI6IjMxMTcxMzZhLThiZTEtNGM0Ny1iY2Y0LTk3MGI2YjVjMmM1ZiIsIm1ldGEiOnsiaW50ZXJhY3Rpb25UeXBlIjoicmVkaXJlY3QifX0%3D";
                    //string baseUrl = $"https://bisteccareltddev.b2clogin.com/bisteccareltddev.onmicrosoft.com/oauth2/v2.0/authorize?p=B2C_1A_SIGNUP&client_id=4521dfe1-0635-4a44-bd4a-f4b42fca2067&nonce=121212&redirect_uri=https://token.botframework.com/api/oauth/PostSignInCallback&scope=openid&response_type=id_token&prompt=login";
