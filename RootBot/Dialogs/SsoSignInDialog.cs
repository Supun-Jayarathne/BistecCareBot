        ...
        private Attachment CreateAdaptiveCardAttachment()
        {
            ...
            using (var stream = GetType().Assembly.GetManifestResourceStream(cardResourcePath))
            {
                using (var reader = new StreamReader(stream))
                {
                    ...
                    string baseUrl = $"https://bisteccareltddev.b2clogin.com/bisteccareltddev.onmicrosoft.com//oauth2/v2.0/authorize?p=B2C_1A_SIGNUP&client_id=4521dfe1-0635-4a44-bd4a-f4b42fca2067&nonce=121212&redirect_uri=http://localhost:3978/api/messages/callback&scope=openid&response_type=id_token&prompt=login";
